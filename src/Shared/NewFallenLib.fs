...
module Dice =
    ...
    let pDie diceFaces = puint32 .>> pchar 'd' .>> pstring diceFaces
    ...
    let emptyDicePool    = { d4=D4 0u; d6= D6 0u; d8= D8 0u; d10= D10 0u; d12= D12 0u; d20= D20 0u}
    ...
    let removeDiceFromDicePool (dicePool:DicePool) (numDiceToRemove:DicePoolPenalty) =
        ...
        { d4=D4 d4; d6= D6 d6; d8= D8 d8; d10= D10 d10; d12= D12 d12; d20= D20 d20}

    let sumDicePool (dicePool: DicePool) =
        let { d4 = d4; d6 = d6; d8 = d8; d10 = d10; d12 = d12; d20 = d20 } = dicePool
        (D4.uint d4) + (D6.uint d6) + (D8.uint d8) + (D10.uint d10) + (D12.uint d12) + (D20.uint d20)
    ...
    let combineDicePoolCalculations dicePoolCalculations =
        List.fold (fun acc next ->
            {
                dicePool = combineDicePools [acc.dicePool;next.dicePool]
